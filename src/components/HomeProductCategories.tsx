...
export default function HomeProductCategories() {
  ...
  return (
    <section ref={sectionRef} className="py-10 sm:py-12 md:py-14 px-4 sm:px-5 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
          {/* Big card */}
          <div className="pcat-item relative overflow-hidden rounded-2xl border border-unicore-accent/10 bg-unicore-dark aspect-square">
            <img
            ...
            <div className="relative p-6 sm:p-8 h-full flex flex-col justify-end">
              ...
              <h3 className="text-white text-2xl sm:text-3xl font-bold leading-tight max-w-[20rem]">
                Industrial Air Coolers
              </h3>
              <p className="text-white/85 text-sm sm:text-base leading-relaxed mt-3 line-clamp-4">
          ...
          <div className="pcat-item flex flex-col gap-4 md:max-w-2xl mx-auto md:mx-0">
            {/* Industrial Fans */}
            <div className="pcat-item group rounded-2xl border border-design-border bg-white overflow-hidden shadow-card hover:border-unicore-accent/40 transition-all duration-300">
              <div className="flex flex-col sm:flex-row h-full">
                <div className="w-full sm:w-5/12 bg-design-bg overflow-hidden sm:h-full sm:p-4 flex items-center justify-center">
                  <img
                ...
                <div className="p-5 sm:p-6 flex-1 flex flex-col">
                  ...
                  <h4 className="text-design-dark font-bold text-lg sm:text-xl mb-2 group-hover:text-unicore-accent transition-colors">
                    Industrial Fans
                  </h4>
                  <p className="text-design-mid text-sm leading-relaxed mb-4 line-clamp-3">

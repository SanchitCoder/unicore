...
export default function Footer() {
  ...
  return (
    <footer className="bg-unicore-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-5 py-8 sm:py-10 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div>
            ...
            <p className="text-white/80 text-sm mb-4">Engineering Excellence Since 2000</p>
          ...
          <div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row gap-2">
              ...
              />
              <button type="submit" className="px-4 py-2.5 min-h-[44px] bg-unicore-accent text-white font-semibold rounded-lg hover:bg-unicore-accent-hover transition-colors text-sm whitespace-nowrap">
                Subscribe
              </button>
            </form>
          </div>
